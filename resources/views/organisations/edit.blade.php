...
<div class="max-w-2xl mx-auto py-8">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-800">{{ isset($organisation) ? 'Edit' : 'Tambah' }} Organisasi</h1>
        <p class="text-gray-500">Isi detail di bawah untuk {{ isset($organisation) ? 'memperbarui' : 'membuat' }} organisasi.</p>
    </div>
