                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($users as $u)
                        <tr class="hover:bg-gray-25 transition-all">
                            ...
                            <td class="px-4 lg:px-8 py-5">
                                <span class="px-2 py-1 rounded-full text-[10px] font-bold uppercase {{ $u->role === 'admin' ? 'bg-purple-50 text-purple-600' : ($u->role === 'leader' ? 'bg-blue-50 text-blue-600' : 'bg-gray-50 text-gray-500') }} border border-current/10">
