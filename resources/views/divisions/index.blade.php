...
<div class="space-y-4 lg:space-y-6">
    ...
    @if(session('success'))
        <div class="bg-green-50 border border-green-100 text-green-600 px-4 py-3 lg:px-6 lg:py-4 rounded-2xl font-medium text-xs lg:text-sm animate-fade-in">
            {{ session('success') }}
        </div>
    @endif
                    ...
                    @forelse($divisions as $div)
                        <tr class="hover:bg-gray-25/50 transition-all">
                            <td class="px-4 lg:px-8 py-4 lg:py-5">
                                <span class="font-bold text-gray-700 block text-sm sm:text-base">{{ $div->name }}</span>
                            </td>
                            <td class="px-4 lg:px-8 py-4 lg:py-5">
